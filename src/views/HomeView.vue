                    ...
                    <div class="row p-5">
                        ...
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left align-self-center">
                                <h1 class="h1 text-success">{{ $t('Zay eCommerce')}}</h1>
                                <h3 class="h2">{{ $t('Tiny and Perfect eCommerce Template')}}</h3>
                                <p>
                                    {{ $t(` Zay Shop is an eCommerce HTML5 CSS template with latest version of Bootstrap 5 (beta 1).
